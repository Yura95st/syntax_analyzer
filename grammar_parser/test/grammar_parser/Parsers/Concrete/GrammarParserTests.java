...
public class GrammarParserTests
{
	...
	public void parse_GrammarRuleDoesNotStartFromNonterminalNode_ThrowsInvalidGrammarException()
		throws Exception
	{
		...
		throws Exception
	{
		...
		Map<SpecialNodeKind, Node> specialNodesDictionary =
			new HashMap<SpecialNodeKind, Node>() {
				{
	...
	public void setUp() throws Exception
	{
		...
		this._specialNodesDictionary =
			this._grammarParser.getSpecialNodesDictionary();
	}
